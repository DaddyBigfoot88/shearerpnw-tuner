...
st.caption("Upload a CSV with columns: Lap, LapDistPct, Speed, Throttle, Brake. Optional: SteeringWheelAngle, YawRate, RRshockVel, CFSRrideHeight, pressures, ride heights. IBT support coming next.")
